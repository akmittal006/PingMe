...
public class CopyOfSearchResultsActivity extends ListActivity {

	public static final String TAG = CopyOfSearchResultsActivity.class
			.getSimpleName();
	...
	protected void onListItemClick(ListView l, View v, final int position,
		...
		if (isFrndReqSent.get(position) == 00) {
							...
							friendRequest.saveInBackground(new SaveCallback() {
								...
								public void done(ParseException e) {
									...
									if (e == null) {
										...
										Toast.makeText(
												CopyOfSearchResultsActivity.this,
	...
	private void showQueryResults() {
		Log.d(TAG, "frndreqSiz :" + isFrndReqSent.size() + "  mUsers Size: "
				+ mUsers.size());
		CopyOfUserAdapter adapter = new CopyOfUserAdapter(CopyOfSearchResultsActivity.this,
				mUsers);
