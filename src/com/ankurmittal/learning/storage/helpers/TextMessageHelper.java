...
public class TextMessageHelper extends SQLiteOpenHelper {
	...
	private static TextMessageHelper sInstance;
	/*
...
//            "ALTER TABLE " + TABLE_MESSAGES + " ADD COLUMN " + COLUMN_IS_SENT + " TEXT" ;
	...
	public static synchronized TextMessageHelper getInstance(Context context) {

		// Use the application context, which will ensure that you
		// don't accidentally leak an Activity's context.
		// See this article for more information: http://bit.ly/6LRzfx
		if (sInstance == null) {
			sInstance = new TextMessageHelper(context.getApplicationContext());
		}
		return sInstance;
	}
    
    
    private TextMessageHelper(Context context) {
